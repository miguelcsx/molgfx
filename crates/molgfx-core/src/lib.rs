...
pub use representation::{
    ...
    CATEGORICAL_COLORS, ColorExpr, ColorOverlay, ColorParameter, ColorScheme, FaceVisibility,
    Guide, GuideCap, GuideStyle, InteractionAnchor, InteractionDirection, InteractionEdge,
    InteractionGeometry, InteractionKind, InteractionPattern, InteractionStyle,
    MAX_COLOR_OVERLAY_CLASSES, MAX_MESH_VERTICES, MAX_VISUAL_INSTRUCTIONS, MAX_VISUAL_PARAMETERS,
    MAX_VISUAL_PROPERTIES, MAX_VOLUME_TRANSFER_POINTS, MarkerShape, MarkerStyle, Material,
    ...
    PropertyLegend, Quadric, Relation, RelationBatch, RelationDependency, RelationLayout,
    RelationPartition, RelationPattern, RelationStyle, Representation, RepresentationConfig,
    RepresentationKind, RepresentationParams, RepresentationPreset, RepresentationTarget,
    SECONDARY_STRUCTURE_COLORS, ScalarContours, ScalarExpr, ScalarFieldSemantics, ScalarParameter,
    ...
    VisualCompatibility, VisualDescriptor, VisualEmitError, VisualError, VisualEvaluation,
    VisualInputs, VisualInstructionGpu, VisualOutput, VisualPipeline, VisualProgram,
    VisualProgramBuilder, VisualStage, VisualStyle, VolumeRegion, VolumeRendering, VolumeSlice,
    VolumeStyle, VolumeTransferFunction, VolumeTransferPoint, cpk_color, emit_resolve,
    is_specializable, is_supported, opcode_name, unsupported, vdw_radius, visual_pipeline,
};
pub use scene::{
