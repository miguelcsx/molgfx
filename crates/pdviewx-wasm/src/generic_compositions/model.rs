...
pub struct WebGenericCompositionView {
    inner: pdviewx::GenericCompositionView,
}

impl From<pdviewx::GenericCompositionView> for WebGenericCompositionView {
    fn from(inner: pdviewx::GenericCompositionView) -> Self {
        Self { inner }
    }
}
