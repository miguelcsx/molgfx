...
//! copied. Every composed unit is validated with naga here, so a shader
//! error fails the build with a file and line rather than surfacing on the
//! first frame. Composed sources are plain standard WGSL.
