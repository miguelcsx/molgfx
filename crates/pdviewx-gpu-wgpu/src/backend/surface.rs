...
use pdviewx_gpu::{SurfaceConfig, SurfaceError, TextureFormat};
...
impl pdviewx_gpu::SurfaceFrame<WgpuDevice> for WgpuFrame {
...
impl pdviewx_gpu::Surface<WgpuDevice> for WgpuSurface {
