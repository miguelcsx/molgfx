...
use pdviewx_gpu::{GpuError, ResourceMemory, TextureDesc};
use std::sync::Arc;
...
pub(crate) fn texture_bytes(desc: &TextureDesc) -> Result<u64, GpuError> {
    let bytes_per_texel = match desc.format {
        pdviewx_gpu::TextureFormat::R8Unorm => 1,
        pdviewx_gpu::TextureFormat::Rg16Float
        | pdviewx_gpu::TextureFormat::Rgba8Unorm
        | pdviewx_gpu::TextureFormat::Rgba8Snorm
        | pdviewx_gpu::TextureFormat::Rgba8UnormSrgb
        | pdviewx_gpu::TextureFormat::Bgra8Unorm
        | pdviewx_gpu::TextureFormat::Bgra8UnormSrgb
        | pdviewx_gpu::TextureFormat::R32Uint
        | pdviewx_gpu::TextureFormat::R32Float
        | pdviewx_gpu::TextureFormat::Depth32Float => 4,
        pdviewx_gpu::TextureFormat::Rgba16Float | pdviewx_gpu::TextureFormat::Rg32Float => 8,
    };
