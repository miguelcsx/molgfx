...
fn paged_instance_timeline_samples_resident_pages_without_rebuilding_batches() {
    ...
    let dataset = pdviewx_core::DatasetId::new(0x1_0000_0017);
...
fn zero_budget_paged_instances_sample_two_resident_pages_directly() {
    ...
    let mut output = ResidencyOutput::default();
    let dataset = pdviewx_core::DatasetId::new(0x1_0000_0018);
    ...
    engine
        .render(&pdviewx_core::Scene::new(), &super::tests::camera())
...
fn install_anchored_relations(
    ...
    source: pdviewx_core::ResidencyTicket,
) {
...
fn instance_offset(
    engine: &super::Engine<crate::testing::MockDevice>,
    ticket: pdviewx_core::ResidencyTicket,
) -> u32 {
    let resident = engine
