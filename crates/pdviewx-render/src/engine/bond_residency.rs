...
use pdviewx_core::{ChunkPayload, ChunkSpan, LogicalRow, ResidencyTicket};
use pdviewx_gpu::{
...
pub(crate) struct BondGpuResidency<D: Device> {
    ...
    tracked_index: HashMap<(pdviewx_core::ResidencyKey, u64), usize>,
...
fn ticket_key(ticket: ResidencyTicket) -> (pdviewx_core::ResidencyKey, u64) {
