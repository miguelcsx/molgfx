...
pub(crate) enum DerivedCacheKey {
    #[cfg(test)]
    Test(u64),
    SceneAttribute(pdviewx_core::AttributeHandle),
    ScenePoint(pdviewx_core::PointBatchHandle),
    SceneInstance(pdviewx_core::InstanceBatchHandle),
    PagedAttribute(pdviewx_core::ResidencyTicket),
    PagedInstance(pdviewx_core::ChunkOccurrenceId),
}
