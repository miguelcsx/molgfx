...
fn full_width_occurrence_keys_never_alias() {
    ...
    let first =
        DerivedCacheKey::PagedInstance(pdviewx_core::ChunkOccurrenceId::new(0x0100_0000_0000_0001));
    let second =
        DerivedCacheKey::PagedInstance(pdviewx_core::ChunkOccurrenceId::new(0x0200_0000_0000_0001));
    assert!(cache.retain(
        first,
