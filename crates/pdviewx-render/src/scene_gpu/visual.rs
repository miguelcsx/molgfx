...
use pdviewx_core::{Representation, VisualInstructionGpu, VisualOutput, VisualStyle};
...
impl VisualBase {
    ...
    pub(super) fn rgba8_opacity(color: pdviewx_math::Rgba8, opacity: f32) -> Self {
        let scale = 1.0 / 255.0;
        Self {
            color: [
...
struct VisualConfigInput<'a> {
    program: &'a pdviewx_core::VisualProgram,
    style: &'a VisualStyle,
    base: VisualBase,
    entity_count: usize,
    result_count: usize,
