...
use pdviewx_core::PlacedStructure;
use pdviewx_gpu::{
...
fn occupancy_shape<D: Device>(
    ...
    let brick = pdviewx_core::ScalarVolume::EMPTY_SPACE_BRICK_SIZE;
...
fn occupancy_uniforms(
    stream: &pdviewx_core::OccupancyStream,
    shape: &OccupancyShape,
) -> OccupancyUniforms {
    OccupancyUniforms {
        ...
        counts: [
            ...
            shape.voxel_count,
            shape.macro_count,
            pdviewx_core::ScalarVolume::EMPTY_SPACE_BRICK_SIZE,
        ],
    }
}
