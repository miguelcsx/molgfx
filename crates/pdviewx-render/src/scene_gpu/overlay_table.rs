...
use pdviewx_core::{OverlayContent, Scene};
    ...
    for (_, overlay) in overlays {
        ...
        match overlay.content() {
            ...
            OverlayContent::CoordinateTripod {
                ...
                for (axis, color) in [
                    pdviewx_math::Rgba8::opaque(239, 68, 68),
                    pdviewx_math::Rgba8::opaque(34, 197, 94),
                    pdviewx_math::Rgba8::opaque(59, 130, 246),
                ]
                .into_iter()
                .enumerate()
                {
...
fn pack_text(
    ...
    anchor: pdviewx_core::OverlayAnchor,
    text: &str,
