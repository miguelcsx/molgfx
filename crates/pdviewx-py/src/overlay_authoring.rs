...
pub(crate) struct PyOverlayAnchor(pub(crate) pdviewx::OverlayAnchor);
...
impl PyOverlayAnchor {
    ...
    fn new(normalized: (f32, f32), pixels: (f32, f32)) -> PyResult<Self> {
        core(pdviewx::OverlayAnchor::new(
...
impl PyScene {
    ...
    fn add_color_legend(
        ...
        self.add_overlay(
            pdviewx::OverlayContent::ColorLegend {
                title,
    ...
    fn add_scale_bar(
        ...
        self.add_overlay(
            pdviewx::OverlayContent::ScaleBar {
                length_angstrom,
                color: color.0,
                width_pixels,
            },
    ...
    fn add_coordinate_tripod(
        ...
        self.add_overlay(
            pdviewx::OverlayContent::CoordinateTripod {
                size_pixels,
                width_pixels,
            },
            anchor.0,
...
impl PyScene {
    fn add_overlay(
        &mut self,
        content: pdviewx::OverlayContent,
        anchor: pdviewx::OverlayAnchor,
        order: i16,
    ) -> PyResult<PyOverlayHandle> {
        let mut overlay = core(pdviewx::ScreenOverlay::new(content, anchor))?;
