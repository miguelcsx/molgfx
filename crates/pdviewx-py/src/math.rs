...
pub(crate) struct PyVec3(pub(crate) pdviewx::Vec3);

#[pymethods]
impl PyVec3 {
    #[new]
    fn new(x: f32, y: f32, z: f32) -> Self {
        Self(pdviewx::Vec3::new(x, y, z))
    }

    #[classattr]
    #[pyo3(name = "ZERO")]
    fn zero() -> Self {
        Self(pdviewx::Vec3::ZERO)
    }
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub(crate) struct PyQuat(pub(crate) pdviewx::Quat);

#[pymethods]
impl PyQuat {
    #[new]
    fn new(x: f32, y: f32, z: f32, w: f32) -> Self {
        Self(pdviewx::Quat::from_xyzw(x, y, z, w))
    }

    #[staticmethod]
    fn identity() -> Self {
        Self(pdviewx::Quat::IDENTITY)
    }
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub(crate) struct PyMat4(pub(crate) pdviewx::Mat4);
...
impl PyMat4 {
    ...
    fn new(values: Vec<f32>) -> PyResult<Self> {
        ...
        Ok(Self(pdviewx::Mat4::from_cols_array(&values)))
    }
...
pub(crate) struct PyRgba8(pub(crate) pdviewx::Rgba8);

impl From<pdviewx::Rgba8> for PyRgba8 {
    fn from(value: pdviewx::Rgba8) -> Self {
        Self(value)
    }
}
...
impl PyRgba8 {
    ...
    fn new(r: u8, g: u8, b: u8, a: u8) -> Self {
        Self(pdviewx::Rgba8::new(r, g, b, a))
    }

    #[staticmethod]
    fn opaque(r: u8, g: u8, b: u8) -> Self {
        Self(pdviewx::Rgba8::opaque(r, g, b))
    }

    #[classattr]
    #[pyo3(name = "WHITE")]
    fn white() -> Self {
        Self(pdviewx::Rgba8::WHITE)
    }
...
pub(crate) struct PyAabb(pub(crate) pdviewx::Aabb);

#[pymethods]
impl PyAabb {
    #[new]
    fn new(min: PyVec3, max: PyVec3) -> Self {
        Self(pdviewx::Aabb::new(min.0, max.0))
    }

    #[classattr]
    #[pyo3(name = "EMPTY")]
    fn empty() -> Self {
        Self(pdviewx::Aabb::EMPTY)
    }
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyBoundingSphere(pub(crate) pdviewx::BoundingSphere);

#[pymethods]
impl PyBoundingSphere {
    #[new]
    fn new(center: PyVec3, radius: f32) -> Self {
        Self(pdviewx::BoundingSphere {
            center: center.0,
            radius,
        })
    }
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyProjection(pub(crate) pdviewx::Projection);
...
impl PyProjection {
    ...
    fn perspective(fov_y: f32, aspect: f32, near: f32, far: f32) -> Self {
        Self(pdviewx::Projection::Perspective {
            fov_y,
            aspect,
            near,
            far,
    ...
    fn orthographic(height: f32, aspect: f32, near: f32, far: f32) -> Self {
        Self(pdviewx::Projection::Orthographic {
            height,
            aspect,
            near,
            far,
    ...
    fn kind(&self) -> &'static str {
        match self.0 {
            pdviewx::Projection::Perspective { .. } => "perspective",
            pdviewx::Projection::Orthographic { .. } => "orthographic",
        }
    }
...
pub(crate) struct PyCamera {
    pub(crate) inner: pdviewx::Camera,
}
...
impl PyCamera {
    ...
    fn framing(bound: PyBoundingSphere, aspect: f32) -> Self {
        Self {
            inner: pdviewx::Camera::framing(&bound.0, aspect),
        }
    }
    ...
    fn framing_aabb(bound: PyAabb, aspect: f32) -> Self {
        Self {
            inner: pdviewx::Camera::framing_aabb(&bound.0, aspect),
        }
    }

    #[staticmethod]
    fn look_at(eye: PyVec3, target: PyVec3, up: PyVec3) -> PyMat4 {
        PyMat4(pdviewx::Camera::look_at(eye.0, target.0, up.0))
    }
...
pub(crate) fn register(module: &Bound<'_, PyModule>) -> PyResult<()> {
    module.add_class::<PyVec3>()?;
    module.add_class::<PyQuat>()?;
    module.add_class::<PyMat4>()?;
    module.add_class::<PyRgba8>()?;
    module.add_class::<PyAabb>()?;
    module.add_class::<PyBoundingSphere>()?;
