...
impl From<PyAtomPropertyMeaning> for pdviewx::AtomPropertyMeaning {
...
#[derive(Clone, Debug)]
pub(crate) struct PyAtomProperty(pub(crate) pdviewx::AtomProperty);
