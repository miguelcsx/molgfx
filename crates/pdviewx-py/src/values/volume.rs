...
pub(crate) struct PyVolumeStyle(pub(crate) pdviewx::VolumeStyle);

#[pymethods]
impl PyVolumeStyle {
    #[staticmethod]
    fn direct() -> Self {
        Self(pdviewx::VolumeStyle::default())
    }
    #[staticmethod]
    fn isosurface() -> Self {
        Self(pdviewx::VolumeStyle::isosurface())
    }
    #[staticmethod]
    fn medium() -> Self {
        Self(pdviewx::VolumeStyle::medium())
    }
    #[staticmethod]
    fn liquid_surface() -> Self {
        Self(pdviewx::VolumeStyle::liquid_surface())
    }
    #[staticmethod]
    fn slice(plane: PyClipPlane) -> Self {
        Self(pdviewx::VolumeStyle::slice(pdviewx::VolumeSlice::new(
            plane.0,
        )))
    }
    fn region(
...
impl From<PyClipCap> for pdviewx::ClipCap {
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyClipPlane(pub(crate) pdviewx::ClipPlane);

#[pymethods]
impl PyClipPlane {
    #[staticmethod]
    fn from_point_normal(point: PyVec3, normal: PyVec3) -> PyResult<Self> {
        core(pdviewx::ClipPlane::from_point_normal(point.0, normal.0)).map(Self)
    }
    #[getter]
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyClipSet(pub(crate) pdviewx::ClipSet);
...
impl PyClipSet {
    ...
    fn new(planes: Vec<PyClipPlane>) -> PyResult<Self> {
        ...
        core(pdviewx::ClipSet::new(&planes)).map(Self)
    }
    #[staticmethod]
    fn slab(center: PyVec3, normal: PyVec3, thickness: f32) -> PyResult<Self> {
        core(pdviewx::ClipSet::slab(center.0, normal.0, thickness)).map(Self)
    }
    ...
    fn cap(&self) -> PyClipCap {
        match self.0.cap() {
            pdviewx::ClipCap::Open => PyClipCap::Open,
            pdviewx::ClipCap::Solid => PyClipCap::Solid,
        }
    }
    #[getter]
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PySegmentStyle(pub(crate) pdviewx::SegmentStyle);

#[pymethods]
impl PySegmentStyle {
    #[new]
    fn new(label: u32, color: PyRgba8, opacity: f32) -> Self {
        Self(pdviewx::SegmentStyle::new(label, color.0, opacity))
    }
    #[getter]
    fn label(&self) -> u32 {
        self.0.label
...
#[derive(Clone, Debug)]
pub(crate) struct PySegmentStyleTable(pub(crate) pdviewx::SegmentStyleTable);
...
impl PySegmentStyleTable {
    ...
    fn new(styles: Vec<PySegmentStyle>) -> PyResult<Self> {
        ...
        core(pdviewx::SegmentStyleTable::new(&styles)).map(Self)
    }
    #[staticmethod]
    fn default() -> Self {
        Self(pdviewx::SegmentStyleTable::default())
    }
...
#[derive(Clone, Debug)]
pub(crate) struct PySegmentationStyle(pub(crate) pdviewx::SegmentationStyle);
...
impl PySegmentationStyle {
    ...
    fn new(styles: Option<PySegmentStyleTable>, opacity_scale: f32, step_scale: f32) -> Self {
        Self(pdviewx::SegmentationStyle {
            styles: styles.map_or_else(pdviewx::SegmentStyleTable::default, |value| value.0),
            opacity_scale,
            step_scale,
            ..pdviewx::SegmentationStyle::default()
        })
    }
    #[staticmethod]
    fn default() -> Self {
        Self(pdviewx::SegmentationStyle::default())
    }
    #[getter]
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyTubeRadiusMapping(pub(crate) pdviewx::TubeRadiusMapping);

#[pymethods]
impl PyTubeRadiusMapping {
    #[staticmethod]
    fn constant() -> Self {
        Self(pdviewx::TubeRadiusMapping::Constant)
    }
    #[staticmethod]
    fn b_factor(domain: (f32, f32), radii: (f32, f32)) -> PyResult<Self> {
        core(pdviewx::TubeRadiusMapping::b_factor(
            [domain.0, domain.1],
            [radii.0, radii.1],
        ))
        .map(Self)
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyCrystalCell(pub(crate) pdviewx::CrystalCell);

#[pymethods]
impl PyCrystalCell {
    #[new]
    fn new(lengths: (f32, f32, f32), angles_degrees: (f32, f32, f32)) -> PyResult<Self> {
        core(pdviewx::CrystalCell::new(
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PySymmetryInstance(pub(crate) pdviewx::SymmetryInstance);

#[pymethods]
impl PySymmetryInstance {
    #[new]
    fn new(id: u32, transform: PyMat4) -> PyResult<Self> {
        core(pdviewx::SymmetryInstance::new(id, transform.0)).map(Self)
    }
    #[getter]
    fn id(&self) -> u32 {
        self.0.id
