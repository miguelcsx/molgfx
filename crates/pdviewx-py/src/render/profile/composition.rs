...
#[derive(Clone, Debug)]
pub(crate) struct PyRenderProfile(pub(crate) pdviewx::RenderProfile);

#[pymethods]
impl PyRenderProfile {
    #[staticmethod]
    fn inspection() -> Self {
        Self(pdviewx::RenderProfile::inspection())
    }

    #[staticmethod]
    fn illustrative() -> Self {
        Self(pdviewx::RenderProfile::illustrative())
    }

    #[staticmethod]
    fn cinematic() -> Self {
        Self(pdviewx::RenderProfile::cinematic())
    }
...
pub(crate) struct PyResolvedRenderPlan(pub(crate) pdviewx::ResolvedRenderPlan);
