...
fn detail(value: pdviewx::ProvenanceDetail<'_>) -> PyProvenanceDetail {
    match value {
        pdviewx::ProvenanceDetail::Atom(_) => PyProvenanceDetail::Atom,
        pdviewx::ProvenanceDetail::Bond(_) => PyProvenanceDetail::Bond,
        pdviewx::ProvenanceDetail::DynamicBond(_) => PyProvenanceDetail::DynamicBond,
        pdviewx::ProvenanceDetail::Interaction(_) => PyProvenanceDetail::Interaction,
        pdviewx::ProvenanceDetail::Guide(_) => PyProvenanceDetail::Guide,
        pdviewx::ProvenanceDetail::Annotation(_) => PyProvenanceDetail::Annotation,
        pdviewx::ProvenanceDetail::Measurement(_) => PyProvenanceDetail::Measurement,
        pdviewx::ProvenanceDetail::Primitive(_) => PyProvenanceDetail::Primitive,
        pdviewx::ProvenanceDetail::Mesh(_) => PyProvenanceDetail::Mesh,
...
impl From<pdviewx::EntityProvenance<'_>> for PyEntityProvenance {
    fn from(value: pdviewx::EntityProvenance<'_>) -> Self {
        Self {
