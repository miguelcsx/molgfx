...
pub(crate) struct PyVisualInstructionGpu(pub(crate) pdviewx::VisualInstructionGpu);

#[pymethods]
impl PyVisualInstructionGpu {
    #[new]
    fn new(control: [u32; 4], data: [f32; 4]) -> Self {
        Self(pdviewx::VisualInstructionGpu { control, data })
    }
    ...
    #[staticmethod]
    fn byte_size() -> usize {
        std::mem::size_of::<pdviewx::VisualInstructionGpu>()
    }
}
