    ...
    fn from(value: PyParticleMotion) -> Self {
        ...
        Self(pdviewx::ParticleMotionDescription {
            ...
            boundary: match value.0.boundary() {
                pdviewx::ParticleBoundary::Bounce => "bounce",
                pdviewx::ParticleBoundary::Wrap => "wrap",
            }
            .to_owned(),
...
#[derive(Clone, Debug)]
pub(crate) struct PyMeshDescription(pub(crate) pdviewx::MeshDescription);
...
#[derive(Clone, Debug)]
pub(crate) struct PyMeshInstanceDescription(pub(crate) pdviewx::MeshInstanceDescription);
...
#[derive(Clone, Debug)]
pub(crate) struct PyOverlayDescription(pub(crate) pdviewx::OverlayDescription);
...
impl PyOverlayDescription {
    ...
    fn copy_from_values(
        ...
        Self(pdviewx::OverlayDescription {
            row,
            generation,
            kind,
            normalized,
...
#[derive(Clone, Debug)]
pub(crate) struct PyPrimitiveDescription(pub(crate) pdviewx::PrimitiveDescription);
