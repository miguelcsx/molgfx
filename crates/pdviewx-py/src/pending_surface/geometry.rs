...
pub(crate) struct PyAnisotropicEllipsoid(pub(crate) pdviewx::AnisotropicEllipsoid);

#[pymethods]
impl PyAnisotropicEllipsoid {
    #[new]
    fn new(center: PyVec3, tensor: [f32; 6]) -> PyResult<Self> {
        core(pdviewx::AnisotropicEllipsoid::new(center.0, tensor)).map(Self)
    }
...
impl From<PyCarbohydrateShape> for pdviewx::CarbohydrateShape {
...
impl From<pdviewx::CarbohydrateShape> for PyCarbohydrateShape {
    fn from(value: pdviewx::CarbohydrateShape) -> Self {
        match value {
            pdviewx::CarbohydrateShape::Glc => Self::Glc,
            pdviewx::CarbohydrateShape::Gal => Self::Gal,
            pdviewx::CarbohydrateShape::Man => Self::Man,
            pdviewx::CarbohydrateShape::Fuc => Self::Fuc,
            pdviewx::CarbohydrateShape::Xyl => Self::Xyl,
            pdviewx::CarbohydrateShape::Neu5Ac => Self::Neu5Ac,
            _ => Self::Unknown,
        }
    }
}
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyCarbohydrateSymbol(pub(crate) pdviewx::CarbohydrateSymbol);
...
impl PyCarbohydrateSymbol {
    ...
    fn new(
        ...
        core(pdviewx::CarbohydrateSymbol::new(
            owner.0,
            center.0,
            orientation.0,
            size.0,
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyPlanarRegion(pub(crate) pdviewx::PlanarRegion);
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyQuadric(pub(crate) pdviewx::Quadric);

#[pymethods]
impl PyQuadric {
    #[new]
    fn new(coefficients: [f32; 10], bounds: PyAabb, cells: [u16; 3]) -> PyResult<Self> {
        core(pdviewx::Quadric::new(coefficients, bounds.0, cells)).map(Self)
    }
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyGuide(pub(crate) pdviewx::Guide);
...
impl PyGuide {
    ...
    fn new(
        ...
        core(pdviewx::Guide::new(owner.0, start.0, end.0, style.0)).map(Self)
    }
