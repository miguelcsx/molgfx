...
pub(crate) fn register(module: &Bound<'_, PyModule>) -> PyResult<()> {
    module.add("MAX_CLIP_PLANES", molgfx::MAX_CLIP_PLANES)?;
    module.add(
        "MAX_VOLUME_TRANSFER_POINTS",
        molgfx::MAX_VOLUME_TRANSFER_POINTS,
    )?;
    module.add("MAX_VISUAL_INSTRUCTIONS", molgfx::MAX_VISUAL_INSTRUCTIONS)?;
    module.add("MAX_VISUAL_PROPERTIES", molgfx::MAX_VISUAL_PROPERTIES)?;
    module.add("MAX_VISUAL_PARAMETERS", molgfx::MAX_VISUAL_PARAMETERS)?;
