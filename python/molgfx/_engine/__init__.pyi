...
class Scene:
    ...
    def bind_trajectory(self, *, source_hash: str, start: TrajectoryFrame, end: TrajectoryFrame, sample_time: float | None = None) -> None: ...
...
_Form = Literal[
    "cartoon", "ball_and_stick", "spacefill", "licorice", "lines", "points",
    "surface", "nucleic_acid", "bases", "base_pairs", "glycan",
]
...
class _Trajectory:
    ...
    def frame(self, index: int, time: float, positions: Sequence[Sequence[float]]) -> TrajectoryFrame: ...
